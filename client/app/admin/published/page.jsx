...
export default function AdminPublishedStockPage() {
  ...
  const refreshData = async () => {
    ...
    try {
      ...
      console.error('Failed to load published stock data:', err);
    } finally {
      setLoading(false);
    }
  };
  ...
  const exportCsv = () => {
    ...
    link.setAttribute('download', 'zylo-published-stock-hierarchy.csv');
  ...
  return (
    <div>
      ...
      <div className="page-head">
        <h2>Published Stock</h2>
        <p>
          Hierarchical operational inventory: click any product to expand its exact <strong>Size → Colour → Quantity</strong> breakdown.
        </p>
      </div>
      ...
      <div className="card table-wrap" style={{ overflowX: 'auto' }}>
        <table>
          ...
          <tbody>
            {loading ? (
              <tr>
                <td colSpan="9"><div className="empty-state">Loading published inventory hierarchy...</div></td>
              </tr>
                  ...
                  <React.Fragment key={p.id}>
                    ...
                    >
                      ...
                      <td style={{ textAlign: 'center' }}>
                        ...
                        >
                          {isExpanded ? 'Hide Stock' : 'View Sizes'}
                        </button>
                      </td>
                    </tr>
              ...
              <tr>
                <td colSpan="9"><div className="empty-state">No published products match the filter.</div></td>
              </tr>
            )}
          </tbody>
        </table>
